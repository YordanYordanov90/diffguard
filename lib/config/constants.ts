...
/** General context retrieval remains bounded independently of targeted evidence. */
export const GENERAL_REVIEW_CONTEXT_MAX_FETCHES = FULL_FILE_CONTEXT_MAX_FILES;
...
/** Bounded per-review retrieval budget for confirmed high/critical evidence. */
export const TARGETED_EVIDENCE_MAX_FILES = 6;
export const TARGETED_EVIDENCE_MAX_FETCHES = 4;
/** Total retrieval allowance, including the reserved targeted-evidence budget. */
export const REVIEW_CONTEXT_MAX_FETCHES =
  GENERAL_REVIEW_CONTEXT_MAX_FETCHES + TARGETED_EVIDENCE_MAX_FETCHES;
export const TARGETED_EVIDENCE_TOTAL_BYTE_LIMIT = 32_000;
export const TARGETED_EVIDENCE_TOTAL_TOKEN_LIMIT = 8_000;
export const TARGETED_EVIDENCE_TIMEOUT_MS = 10_000;
...
export const SECURITY_VERIFICATION_OUTPUT_TOKEN_BUDGET = 5_000;
